...
const WishDialog = (props) => {
	...
	return (
		<div className='detail-wish-dialog'>
			<div className='detail-wish-dialog-mask'></div>
			{wishType === 'NEWUSER' && (
				<div className='detail-wish-dialog-newuser'>
					<div className='detail-wish-dialog-success tac'>参与成功</div>
					<div className='detail-wish-dialog-congratulations tac'>
						恭喜解锁天天抽奖【心愿金】
					</div>
					<div className='detail-wish-dialog-get'>获得心愿金</div>
					<div className='detail-wish-dialog-acount'>50</div>
			...
			{wishType === 'CONTINUITYTHREE' ||
				(wishType === 'CONTINUITYFIVE' && (
					<div className='detail-wish-dialog-three'>
						<div className='detail-wish-dialog-success tac'>
							成功参与{wishType === 'CONTINUITYTHREE' ? '3' : '5'}次抽奖
						</div>
						{wishType === 'CONTINUITYTHREE' ? (
							<>
								<div className='detail-wish-dialog-get mt-56'>获得心愿金</div>
								...
								<img
									className='detail-wish-dialog-hearticon'
									src='https://mdn.alipayobjects.com/huamei_zjbdv1/afts/img/A*7IqXQ6Ex45MAAAAAAAAAAAAADg6FAQ/original'
								/>
							</>
						) : (
							<img
								className='detail-wish-dialog-img'
								src={
									wishImage ||
									'https://mdn.alipayobjects.com/huamei_zjbdv1/afts/img/A*WJ12RYt6AjsAAAAAAAAAAAAADg6FAQ/original'
								}
							/>
						)}
